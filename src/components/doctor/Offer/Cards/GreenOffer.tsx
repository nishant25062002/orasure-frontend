...
const GreenOffer = ({ joined = false }: { joined?: boolean }) => {
  return (
    <div className="bg-[#fff] rounded-[16px]">
      <div className="bg-[#68A400] rounded-[16px]">
        <div
          className={`rounded-[16px] text-[#fff] w-full p-[20px_12px] relative mt-[20px]`}
        >
          <div className="text-[18px] leading-[20px] font-[600]">
