...
import Divider from "../global/Divider.tsx";

const Payment = ({ monthly = false }: { monthly?: boolean }) => {
  const data = [
    {
  ...
  return (
    <div className="flex flex-col items-center justify-center my-[20px] mx-[8px]">
      <div className="max-w-[350px] w-[98%] rounded-[16px] border-[1px] border-[#9EC55B] py-[24px]">
        <div className="p-[0_22px]">
          <div className=" mb-[34px] text-[#222] text-[20px] font-[700] uppercase">
            Enamel Health Plan
          </div>
        ...
        <div className="p-[0_13px]">
          <div className="mt-[38px]">
            ...
            <Divider customStyle={"mt-[12px] mb-[19px] !h-[1px] bg-[#888]"} />
            {monthly && (
