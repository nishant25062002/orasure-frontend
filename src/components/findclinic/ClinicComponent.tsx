...
const ClinicComponent = () => {
  return (
    <div className="rounded-[6px] bg-[#fff] my-[12px] p-[17px]">
      <div className="flex">
      ...
      <div className="flex w-full">
        <div className="text-[14px] font-[700] text-[#9EC55B] w-[64px] text-center">
          Available Now
        </div>
        <CustomButton text={"Schedule an Appointments"} />
      </div>
    </div>
  );
};
